...
import com.example.grades24.data.Utils;
...
public class StartQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tvTitle = findViewById(R.id.textView26);
            ...
            questionsAnswerMap = Utils.getRandomLiterateQues(this,getString(R.string.literature),constants.QUESTION_SHOWING);
        ...
        btnNext = findViewById(R.id.button13);
        ...
        findViewById(R.id.button13).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (btnNext.getText().equals(getString(R.string.next))){
                    ...
                    Intent intentResult = new Intent(StartQuizActivity.this,FinalResultActivity.class);
